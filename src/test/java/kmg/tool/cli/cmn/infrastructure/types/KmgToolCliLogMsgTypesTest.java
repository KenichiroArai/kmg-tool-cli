...
public class KmgToolCliLogMsgTypesTest {
     ...
     * @since 0.1.1
     */
    public KmgToolCliLogMsgTypesTest() {
    ...
    public void testConstructor_normalConstructor() {
        ...
        /* 準備 */
        final KmgToolCliLogMsgTypes testType = KmgToolCliLogMsgTypes.NONE;
    ...
    public void testGetDefault_normalDefaultValue() {
        ...
        /* 期待値の定義 */
        final KmgToolCliLogMsgTypes expected = KmgToolCliLogMsgTypes.NONE;

        /* テスト対象の実行 */
        final KmgToolCliLogMsgTypes actual = KmgToolCliLogMsgTypes.getDefault();
    ...
    public void testGetEnum_normalExistingValue() {
        ...
        /* テスト対象の実行 */
        final KmgToolCliLogMsgTypes actual = KmgToolCliLogMsgTypes.getEnum(key);
    ...
    public void testGetEnum_semiNonExistingValue() {
        ...
        /* テスト対象の実行 */
        final KmgToolCliLogMsgTypes actual = KmgToolCliLogMsgTypes.getEnum(testValue);
    ...
    public void testGetInitValue_normalInitialValue() {
        ...
        /* テスト対象の実行 */
        final KmgToolCliLogMsgTypes actual = KmgToolCliLogMsgTypes.getInitValue();
